# 1. Explain what built-in functions are? Then describe and proivde a
# code example of 3 built-in function we HAVE NOT learned about in class


# 2. provide 3 cod examples of how to use a conditional statement. you will need to use on of each of the following
